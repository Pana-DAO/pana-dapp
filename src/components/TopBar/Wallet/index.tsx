...
const WalletButton = ({ openWallet }: { openWallet: () => void }) => {
  ...
  return (
    <Button id="pana-menu-button" variant="contained" color="secondary" onClick={onClick}>
      <SvgIcon component={WalletIcon} style={{ marginRight: theme.spacing(1) }} viewBox="0 0 18 13" />
