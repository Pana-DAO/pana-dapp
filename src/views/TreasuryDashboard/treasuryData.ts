...
export const tooltipInfoMessages = () => {
  return {
    tvl: t`Total Value Deposited, is the dollar amount of all PANA wrapped in the protocol. This metric is often used as growth or health indicator in DeFi projects.`,
    mvt: t`Market Value of Treasury Assets, is the sum of the value (in dollars) of all assets held by the treasury.`,
    rfv: t`Risk Free Value, is the amount of funds the treasury guarantees to use for backing PANA.`,
    ...
    holder: t`Holders, represents the total number of Aryas (KARSHA holders)`,
    wrapped: t`PANA Wrapped, is the ratio of KARSHA to PANA (wrapped vs unwrapped)`,
    ...
    runway: t`Runway, is the number of days KARSHA emissions can be sustained at a given rate. Lower APY = longer runway`,
  };
};
