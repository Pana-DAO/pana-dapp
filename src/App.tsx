...
import { Exchange, TreasuryDashboard, Bond, ChooseBond, Memorandum } from "./views";
...
function App() {
  ...
  const bondIndexes = useAppSelector(state => state.bonding.indexes);
  ...
  useEffect(() => {
    ...
    if (shouldTriggerSafetyCheck()) {
      dispatch(info("Safety Check: Always verify you're on app.panadao.finance!"));
    }
  }, []);
